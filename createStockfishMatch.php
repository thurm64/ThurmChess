...
<main>
<h2 class="title" style="color:#335577">Play Computer</h2>
<br>
<h4>Play as </h4>
    ...
    function submit() {
        var div = document.getElementById("play-link");
            if(!document.getElementById('white').checked) {
                div.innerHTML = '<a href="stockfish.php?blackPlayer=' + window.whitePlayer + "&id=" + window.idec + '">Click to play!</a>';
            } else {
                div.innerHTML = '<a href="stockfish.php?whitePlayer=' + window.whitePlayer + "&id=" + window.idec + '">Click to play!</a>';
            }
